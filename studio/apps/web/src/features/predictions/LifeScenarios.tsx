  ...
  return <>
    ...
    {scenario && <article className="prediction-detail life-scenario-detail" aria-label="所选生活情景">
      ...
      {step===0 && <section aria-label="五年生活">
        <p className="prediction-detail-summary">{scenario.lenses.life} {scenario.lenses.work !== scenario.lenses.life ? scenario.lenses.work : ""}</p>
