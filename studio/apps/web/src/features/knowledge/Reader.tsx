...
import { DocumentOutline, EditableDocument, ReadOnlyDocument, documentHeadingPrefix } from "../../shared/markdown";
  ...
  return (
    <div className="reader-layout">
      <article className="reader">
        ...
        {new URLSearchParams(location.search).has("detached") ? <ReadOnlyDocument id={page.id} markdown={page.renderedMarkdown} /> : <EditableDocument page={page} onRenamed={(renamed) => navigate(pageHref(renamed.id), { replace: true, state: returnContext })} />}
      </article>
